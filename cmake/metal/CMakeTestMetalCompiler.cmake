...
# This file is used by EnableLanguage in cmGlobalGenerator to determine that the
# selected C++ compiler can actually compile and link the most basic of
# programs.   If not, a fatal error is set and cmake stops processing commands
# and will not generate any makefiles or projects.
...
if(NOT CMAKE_Metal_COMPILER_WORKS)
  ...
  # Unlike C and CXX we do not yet detect any information about the Metal ABI.
  # However, one of the steps done for C and CXX as part of that detection is to
  # initialize the implicit include directories.  That is relevant here.
